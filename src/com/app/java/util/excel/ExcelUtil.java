...
//                }
    ...
    public static void ExportPiToFile(PiStatus piStatus, PiStatus piStatus1, PiStatus piStatus2, PiStatus piStatus3, PiStatus piStatus4, PiStatus piStatus5) {
        XSSFWorkbook workbook = new XSSFWorkbook();
        ...
        Row openObjectivesRow = sheet.createRow(rowStartPoint);
        Cell openObjectivesRowCellA = openObjectivesRow.createCell(0);
        openObjectivesRowCellA.setCellValue("Objectives Open");
        Cell openObjectivesRowCellC = openObjectivesRow.createCell(2);
        openObjectivesRowCellC.setCellValue(piStatus.getPiSprints()[0].getObjectivesOpen());
        Cell openObjectivesRowCellD = openObjectivesRow.createCell(3);
        openObjectivesRowCellD.setCellValue(piStatus.getPiSprints()[1].getObjectivesOpen());
        Cell openObjectivesRowCellE = openObjectivesRow.createCell(4);
        openObjectivesRowCellE.setCellValue(piStatus.getPiSprints()[2].getObjectivesOpen());
        Cell openObjectivesRowCellF = openObjectivesRow.createCell(5);
        openObjectivesRowCellF.setCellValue(piStatus.getPiSprints()[3].getObjectivesOpen());
        Cell openObjectivesRowCellG = openObjectivesRow.createCell(6);
        openObjectivesRowCellG.setCellValue(piStatus.getPiSprints()[4].getObjectivesOpen());
        Cell openObjectivesRowCellH = openObjectivesRow.createCell(7);
        openObjectivesRowCellH.setCellValue(piStatus.getPiSprints()[5].getObjectivesOpen());
        ...
        new PiTeamDataToExcel(workbook, piStatus5);
